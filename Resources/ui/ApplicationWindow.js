...
var CONFIG = {
	// Get from Opentok website ()
	apiKey: '1127',
	// Generated by server-side SDK
...
function removePublisher() {
	if (publisher && publisher.view) {
		self.remove(publisher.view);
	}
	delete publisher;
}
...
function publisherStartedHandler(event) {
	...
	// Add the publisher view to the screen
