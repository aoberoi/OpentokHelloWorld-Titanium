...
MAKE_SYSTEM_PROP(ACTIVITY,UIOpentokHelloWorldNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIOpentokHelloWorldNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIOpentokHelloWorldNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIOpentokHelloWorldNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIOpentokHelloWorldNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIOpentokHelloWorldNativeItemContactAdd);
