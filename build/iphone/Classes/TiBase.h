...
// in simulator we redefine to format for OpentokHelloWorld Developer console
...
{\
	NSString * exceptionName = [@"org.opentokhelloworld." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.opentokhelloworld";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIOpentokHelloWorldNativeItemNone = -1, 
	UIOpentokHelloWorldNativeItemSpinner = -2,
	UIOpentokHelloWorldNativeItemProgressBar = -3,
	
	UIOpentokHelloWorldNativeItemSlider = -4,
	UIOpentokHelloWorldNativeItemSwitch = -5,
	UIOpentokHelloWorldNativeItemMultiButton = -6,
	UIOpentokHelloWorldNativeItemSegmented = -7,
	
	UIOpentokHelloWorldNativeItemTextView = -8,
	UIOpentokHelloWorldNativeItemTextField = -9,
	UIOpentokHelloWorldNativeItemSearchBar = -10,
	
	UIOpentokHelloWorldNativeItemPicker = -11,
	UIOpentokHelloWorldNativeItemDatePicker = -12,
	
	UIOpentokHelloWorldNativeItemInfoLight = -13,
	UIOpentokHelloWorldNativeItemInfoDark = -14,
	
	UIOpentokHelloWorldNativeItemDisclosure = -15,
	
	UIOpentokHelloWorldNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all OpentokHelloWorld instances of
