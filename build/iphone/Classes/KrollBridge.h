...
@interface OpentokHelloWorldObject : KrollCoverageObject {
#else
@interface OpentokHelloWorldObject : KrollObject {
#endif
@private
...
extern NSString * OpentokHelloWorld$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	OpentokHelloWorldObject *_opentokhelloworld;
	BOOL shutdown;
