 ...
 * Copyright (c) 2009-2011 by OpentokHelloWorld, Inc. All Rights Reserved.
...
//@interface OpentokHelloWorldObject : NSObject
//@end

@interface OpentokHelloWorldObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[OpentokHelloWorldObject class]])
		{
			for (NSString *key in [[(OpentokHelloWorldObject*)o modules] allKeys])
			{
